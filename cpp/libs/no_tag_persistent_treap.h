...
class NoTagPersistentTreap {
 ...
 public:
   ...
   */
  static pair<NoTagPersistentTreap *, NoTagPersistentTreap *> SplitByRank(
      NoTagPersistentTreap *root, int rank) {
    if (root == NIL) {
      return mp(NIL, NIL);
    }
    root = Clone(root);
  ...
  static NoTagPersistentTreap *Merge(NoTagPersistentTreap *a,
                                     NoTagPersistentTreap *b) {
    if (a == NIL) {
      return b;
    }
    if (b == NIL) {
   ...
   */
  static pair<NoTagPersistentTreap *, NoTagPersistentTreap *> SplitByKey(
      NoTagPersistentTreap *root, int key) {
    if (root == NIL) {
      return mp(NIL, NIL);
    }
    root = Clone(root);
...
NoTagPersistentTreap *NoTagPersistentTreap::NIL =
    new NoTagPersistentTreap(false);
