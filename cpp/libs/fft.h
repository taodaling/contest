...
namespace fast_fourie_transform
{
using namespace std;
...
void DotMul(vector<int> &a, vector<int> &b){
...
vector<int> MultiplyBigInt(const vector<int> &a, const vector<int> &b, int base)
{
...
vector<int> MultiplyMod(const vector<int> &a, const vector<int> &b, int m)
{
