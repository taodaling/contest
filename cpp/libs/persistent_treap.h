...
public:
     ...
     */
    static pair<PersistentTreap *, PersistentTreap *> SplitByRank(PersistentTreap *root, int rank)
    {
        if (root == NIL)
        {
            return mp(NIL, NIL);
     ...
     */
    static pair<PersistentTreap *, PersistentTreap *> SplitByKey(PersistentTreap *root, int key)
    {
        if (root == NIL)
        {
            return mp(NIL, NIL);
