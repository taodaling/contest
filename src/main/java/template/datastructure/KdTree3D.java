 ...
 * <br>
 */
public class KdTree3D<T extends KdTree3D.XYZPoint> implements Iterable<T> {
     ...
     */
    public KdTree3D(List<XYZPoint> list) {
        super();
     ...
     * @param k    of the tree.
     */
    public KdTree3D(List<XYZPoint> list, int k) {
        super();
        root = createNode(list, k, 0);
    }
     ...
     */
    private static final <T extends KdTree3D.XYZPoint> KdNode getNode(KdTree3D<T> tree, T value) {
    ...
    private static final <T extends KdTree3D.XYZPoint> void searchNode(T value, KdNode node, int K, TreeSet<KdNode> results, Set<KdNode> examined) {
        examined.add(node);
    ...
    protected static class TreePrinter {
        ...
        public static <T extends XYZPoint> String getString(KdTree3D<T> tree) {
            if (tree.root == null)
