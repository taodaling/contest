...
public class MultiWayDoubleDeque {
    ...
    public DoubleDeque getDeque(int qId) {
        return new DoubleDeque() {
            ...
            public void addFirst(double x) {
                MultiWayDoubleDeque.this.addFirst(qId, x);
            }

            @Override
            public double removeFirst() {
                return MultiWayDoubleDeque.this.removeFirst(qId);
            }

            @Override
            public double peekFirst() {
                return MultiWayDoubleDeque.this.peekFirst(qId);
            }

            @Override
            public void addLast(double x) {
                MultiWayDoubleDeque.this.addLast(qId, x);
            }

            @Override
            public double removeLast() {
                return MultiWayDoubleDeque.this.removeLast(qId);
            }

            @Override
            public double peekLast() {
                return MultiWayDoubleDeque.this.peekLast(qId);
            }

            @Override
            public DoubleIterator iterator() {
                return MultiWayDoubleDeque.this.iterator(qId);
            }

            @Override
            public boolean isEmpty() {
                return MultiWayDoubleDeque.this.isEmpty(qId);
            }
    ...
    public MultiWayDoubleDeque(int qNum, int totalCapacity) {
