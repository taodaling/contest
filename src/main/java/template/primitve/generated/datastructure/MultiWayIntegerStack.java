...
public class MultiWayIntegerStack {
    private int[] values;
    private int[] next;
    private int[] heads;
    private int alloc;
    ...
    public IntegerStack getStack(int qId){
        return new IntegerStack() {
            ...
            public void addLast(int x) {
                MultiWayIntegerStack.this.addLast(qId, x);
            }

            @Override
            public int removeLast() {
                return MultiWayIntegerStack.this.removeLast(qId);
            }

            @Override
            public int peekLast() {
                return MultiWayIntegerStack.this.peekLast(qId);
            }

            @Override
            public IntegerIterator iterator() {
                return MultiWayIntegerStack.this.iterator(qId);
            }

            @Override
            public boolean isEmpty() {
                return MultiWayIntegerStack.this.isEmpty(qId);
            }
        };
    }
