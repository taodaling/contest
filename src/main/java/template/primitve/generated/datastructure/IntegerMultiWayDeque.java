...
public class IntegerMultiWayDeque {
    private int[] values;
    private int[] next;
    private int[] prev;
    private int[] heads;
    ...
    public IntegerDeque getDeque(int qId) {
        return new IntegerDeque() {
            ...
            public void addFirst(int x) {
                IntegerMultiWayDeque.this.addFirst(qId, x);
            }

            @Override
            public int removeFirst() {
                return IntegerMultiWayDeque.this.removeFirst(qId);
            }

            @Override
            public int peekFirst() {
                return IntegerMultiWayDeque.this.peekFirst(qId);
            }

            @Override
            public void addLast(int x) {
                IntegerMultiWayDeque.this.addLast(qId, x);
            }

            @Override
            public int removeLast() {
                return IntegerMultiWayDeque.this.removeLast(qId);
            }

            @Override
            public int peekLast() {
                return IntegerMultiWayDeque.this.peekLast(qId);
            }
            ...
            public boolean isEmpty() {
                return IntegerMultiWayDeque.this.isEmpty(qId);
            }
