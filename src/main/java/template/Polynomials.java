...
public class Polynomials {
    ...
    public static void mul(IntList a, IntList b, IntList c, NumberTheory.Modular mod) {
        int rA = rankOf(a);
        int rB = rankOf(b);
        c.clear();
    ...
    public static void plus(IntList a, IntList b, IntList c, NumberTheory.Modular mod) {
        int rA = rankOf(a);
        int rB = rankOf(b);
        c.clear();
    ...
    public static void subtract(IntList a, IntList b, IntList c, NumberTheory.Modular mod) {
        int rA = rankOf(a);
        int rB = rankOf(b);
        c.clear();
        c.expandWith(0, Math.max(rA, rB) + 1);
    ...
    public static void mul(IntList a, int k, NumberTheory.Modular mod) {
        int[] aData = a.getData();
    ...
    public static void dotMul(IntList a, IntList b, IntList c, NumberTheory.Modular mod) {
        int rA = rankOf(a);
        int rB = rankOf(b);
     ...
     * a = b * c + remainder
     */
    public static void divide(IntList a, IntList b, IntList c, IntList remainder, NumberTheory.Power pow) {
     ...
     */
    public static void module(long k, IntList p, IntList remainder, NumberTheory.Power pow) {
        int rP = rankOf(p);
        if (rP == 0) {
            remainder.clear();
            remainder.add(0);
    ...
    private static void module(long k, IntList a, IntList b, IntList c, IntList remainder, int rb, NumberTheory.Power pow) {
        NumberTheory.Modular mod = pow.getModular();
        if (k < rb) {
            remainder.clear();
     ...
     * Try find x^k % p = remainder
     */
    public static void module(ByteList k, IntList p, IntList remainder, NumberTheory.Power pow) {
        int rP = rankOf(p);
        if (rP == 0) {
            remainder.clear();
            remainder.add(0);
    ...
    private static void module(ByteList k, IntList a, IntList b, IntList c, IntList remainder, NumberTheory.Power pow) {
        NumberTheory.Modular mod = pow.getModular();
        remainder.clear();
