    ...
    public Test create(int testNum) {
        ...
        for (int i = 0; i < n; i++) {
            ...
            if (t == 0) {
                ...
                op = SequenceUtils.wrapArray(t, index);
            }
            ops[i] = op;
        }
        ...
        for (int i = 1; i <= n; i++) {
            ...
            if (t == 0) {
                ...
                for (int j = index; j >= 0; j--) {
                    if (data[i][j]) {
                        firstSet = Math.max(firstSet, j);
                    }else{
                        firstClear = Math.max(firstClear, j);
                    }
                }
                builder.append(firstSet).append(' ').append(firstClear).append('\n');
            }
