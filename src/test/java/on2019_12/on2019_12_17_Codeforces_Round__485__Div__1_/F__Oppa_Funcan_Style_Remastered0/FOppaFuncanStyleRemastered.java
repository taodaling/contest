package on2019_12.on2019_12_17_Codeforces_Round__485__Div__1_.F__Oppa_Funcan_Style_Remastered0;
...
public class FOppaFuncanStyleRemastered {
    ...
    public void handle(long k, List<Query> queries) {
        Map<Long, Long> allPrimeFactors = pollardRho.findAllFactors(k);
