package on2021_10.on2021_10_11_DMOJ___DMOPC__21_Contest_2.P5___Permutations;
...
public class P5Permutations {
    ...
    void dfs(Node root, Node p) {
        ...
        int numChildren = root.adj.size();
        if (p != null) {
            numChildren--;
        }
        long[][] prev = new long[numChildren + 1][root.size];
        long[][] next = new long[numChildren + 1][root.size];
        prev[0][0] = 1;
        int size = 1;
        int num = 0;
