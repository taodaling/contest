package on2020_12.on2020_12_12_Luogu.P4219__BJOI2014____;
    ...
    public void solve(int testNumber, FastInput in, FastOutput out) {
        ...
        for(int i = 0; i < q; i++){
            ...
            if(c == 'A'){
                ...
                long ans = (long)(nodes[a].sub + 1) * (nodes[b].sub + 1);
                out.println(ans);
            }
        }
    }
...
class LCTNode {
    ...
    public void pushUp() {
        ...
        size = left.size + right.size + 1 + sub;
    }
}
